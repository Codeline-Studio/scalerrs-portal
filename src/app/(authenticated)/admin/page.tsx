...
export default function Admin () {
  ...
  const [passwordModal, setPasswordModal] = useState(
    { isOpen: false, accessId: null as number | null })
  ...
  return (
    <>
      <div className="mb-6">
        ...
        <p className="text-mediumGray">Manage your campaign settings and
          resources</p>
      </div>

      {data.missingAccess && (
        <div
          className="bg-amber-50 border-l-4 border-amber-400 p-4 mb-6 rounded-scalerrs">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm text-amber-700">
                ⚠️ Missing CMS access — please complete setup in the Access &
                Logins tab.
              </p>
            </div>
          </div>
