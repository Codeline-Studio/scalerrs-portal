...
export default function AdminOnboarding ({
  ...
  return (
    <div>
      <h2 className="text-lg font-medium text-dark mb-4">Client Onboarding
        Form</h2>
      <p className="text-mediumGray mb-6">Complete this form to help us better
        understand your business and SEO goals.</p>

      <form className="space-y-6" onSubmit={handleSubmit}>
        <div
          className="bg-white border border-lightGray rounded-scalerrs overflow-hidden">
          <div className="p-4 border-b border-lightGray bg-gray-50">
            <h3 className="text-md font-medium text-dark">Business
              Information</h3>
          </div>
          ...
          <div className="p-4">
            <div className="space-y-4">
              <Textarea
                ...
                onChange={(e) => onChange(
                  { ...data, competitors: e.target.value })}
                className="h-24"
              />
              ...
              <Textarea
                ...
                onChange={(e) => onChange(
                  { ...data, targetAudience: e.target.value })}
        ...
        <div
          className="bg-white border border-lightGray rounded-scalerrs overflow-hidden">
          <div className="p-4 border-b border-lightGray bg-gray-50">
            <h3 className="text-md font-medium text-dark">Current SEO
              Status</h3>
          </div>
          ...
          <div className="p-4">
            <div className="space-y-4">
              <Textarea
                ...
                onChange={(e) => onChange(
                  { ...data, existingKeywords: e.target.value })}
              ...
              <Textarea
                ...
                onChange={(e) => onChange(
                  { ...data, contentStrategy: e.target.value })}
              ...
              <Textarea
                ...
                onChange={(e) => onChange(
                  { ...data, technicalIssues: e.target.value })}
        ...
        <div
          ...
          <div className="p-4">
            <div className="space-y-4">
              <p className="text-sm text-mediumGray">Select the analytics
                platforms you currently use:</p>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="ga" className="ml-2 block text-sm text-dark">Google
                    Analytics</label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="gsc" className="ml-2 block text-sm text-dark">Google
                ...
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="ahrefs"
                         className="ml-2 block text-sm text-dark">Ahrefs</label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="semrush"
                         className="ml-2 block text-sm text-dark">SEMrush</label>
                </div>
        ...
        <div
          className="bg-white border border-lightGray rounded-scalerrs overflow-hidden">
          <div className="p-4 border-b border-lightGray bg-gray-50">
            <h3 className="text-md font-medium text-dark">Additional
              Information</h3>
          </div>

          <div className="p-4">
            <Label htmlFor={'additionalNotes'}>
              <span className="text-sm text-mediumGray">Additional Notes</span>
            </Label>
            <Textarea
              id={'additionalNotes'}
              value={data.additionalNotes}
              onChange={(e) => onChange(
                { ...data, additionalNotes: e.target.value })}
