...
export default function EditAccessModal ({
  ...
  return (
    ...
    >
      <div className="mb-4">
        <label className="block text-sm font-medium text-mediumGray mb-1">Access
          Level</label>
        <select
