  ...
  const renderData = () => {
    ...
    switch (activeTab) {
      case 'tasks':
        return (
          <div className="p-4">
            <h2 className="text-xl font-semibold mb-4">Tasks
              ({tasks.length})</h2>
      ...
      case 'briefs':
        return (
          <div className="p-4">
            <h2 className="text-xl font-semibold mb-4">Briefs
              ({briefs.length})</h2>
            <div className="grid gap-4">
              {briefs.map(brief => (
                <div key={brief.id} className="bg-white p-4 rounded-lg shadow">
                  <h3 className="font-semibold">{brief.Title}</h3>
                  <p className="text-gray-600">SEO
                    Strategist: {brief.SEOStrategist}</p>
      ...
      case 'articles':
        return (
          <div className="p-4">
            <h2 className="text-xl font-semibold mb-4">Articles
              ({articles.length})</h2>
            <div className="grid gap-4">
              {articles.map(article => (
                <div key={article.id}
                  ...
                  <p className="text-gray-600">Word
                    Count: {article.WordCount}</p>
      ...
      case 'backlinks':
        return (
          <div className="p-4">
            <h2 className="text-xl font-semibold mb-4">Backlinks
              ({backlinks.length})</h2>
            <div className="grid gap-4">
              {backlinks.map(backlink => (
                <div key={backlink.id}
                  ...
                  <p className="text-gray-600">Target
                    Page: {backlink.TargetPage}</p>
                  <div className="mt-2">
                    <span
                      className="inline-block px-2 py-1 text-sm bg-blue-100 text-blue-800 rounded">
                      {backlink.Status}
      ...
      case 'kpi-metrics':
        return (
          <div className="p-4">
            <h2 className="text-xl font-semibold mb-4">KPI Metrics
              ({kpiMetrics.length})</h2>
            <div className="grid gap-4">
              {kpiMetrics.map(metric => (
                <div key={metric.id} className="bg-white p-4 rounded-lg shadow">
                  <h3 className="font-semibold">{metric.MetricName}</h3>
                  <p className="text-gray-600">Current
                    Value: {metric.CurrentValue}</p>
                  <p className="text-gray-600">Previous
                    Value: {metric.PreviousValue}</p>
                  <p
                    className="text-gray-600">Change: {metric.ChangePercentage}%</p>
                </div>
              ))}
            </div>
          </div>
      ...
      case 'url-performance':
        return (
          <div className="p-4">
            <h2 className="text-xl font-semibold mb-4">URL Performance
              ({urlPerformance.length})</h2>
            <div className="grid gap-4">
              {urlPerformance.map(url => (
                <div key={url.id} className="bg-white p-4 rounded-lg shadow">
                  ...
                  <p
                    className="text-gray-600">Impressions: {url.Impressions}</p>
                  <p className="text-gray-600">CTR: {url.CTR}%</p>
                  <p className="text-gray-600">Avg
                    Position: {url.AveragePosition}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      case 'keyword-performance':
        return (
          <div className="p-4">
            <h2 className="text-xl font-semibold mb-4">Keyword Performance
              ({keywordPerformance.length})</h2>
            <div className="grid gap-4">
              {keywordPerformance.map(keyword => (
                <div key={keyword.id}
                  ...
                  <p
                    className="text-gray-600">Difficulty: {keyword.Difficulty}</p>
                  <p className="text-gray-600">Current
                    Position: {keyword.CurrentPosition}</p>
                  <p className="text-gray-600">Previous
                    Position: {keyword.PreviousPosition}</p>
                  <p
                    className="text-gray-600">Change: {keyword.PositionChange}</p>
                </div>
              ))}
            </div>
          </div>
    ...
    <DashboardLayout>
      <div className="container mx-auto py-8">
        ...
        <div className="flex border-b mb-6">
          <Button
            className={`px-4 py-2 ${activeTab === 'tasks'
          ...
          <Button
            className={`px-4 py-2 ${activeTab === 'briefs'
              ? 'border-b-2 border-blue-500 font-semibold'
              : ''}`}
          ...
          <Button
            className={`px-4 py-2 ${activeTab === 'articles'
              ? 'border-b-2 border-blue-500 font-semibold'
              : ''}`}
          ...
          <Button
            className={`px-4 py-2 ${activeTab === 'backlinks'
              ? 'border-b-2 border-blue-500 font-semibold'
              : ''}`}
          ...
          <Button
            className={`px-4 py-2 ${activeTab === 'kpi-metrics'
              ? 'border-b-2 border-blue-500 font-semibold'
              : ''}`}
          ...
          <Button
            className={`px-4 py-2 ${activeTab === 'url-performance'
              ? 'border-b-2 border-blue-500 font-semibold'
              : ''}`}
          ...
          <Button
            className={`px-4 py-2 ${activeTab === 'keyword-performance'
              ? 'border-b-2 border-blue-500 font-semibold'
              : ''}`}
