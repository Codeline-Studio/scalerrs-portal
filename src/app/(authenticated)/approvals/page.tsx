...
const approvalItems = {
  keywords: [
    {
      id: 1,
      item: 'enterprise seo services',
      volume: 1200,
      difficulty: 'High',
      status: 'awaiting_approval',
      dateSubmitted: '2025-04-01',
      lastUpdated: '2 days ago',
      strategist: 'Taylor Roberts',
    },
    {
      id: 2,
      item: 'seo agency for saas',
      volume: 880,
      difficulty: 'Medium',
      status: 'awaiting_approval',
      dateSubmitted: '2025-04-01',
    ...
    {
      id: 3,
      item: 'b2b seo strategy',
      volume: 720,
      difficulty: 'Medium',
      status: 'resubmitted',
      dateSubmitted: '2025-03-30',
      lastUpdated: '3 days ago',
      strategist: 'Alex Johnson',
    },
    {
      id: 4,
      item: 'content marketing for tech',
      volume: 1500,
      difficulty: 'High',
      status: 'approved',
      dateSubmitted: '2025-03-28',
      dateApproved: '2025-03-29',
      lastUpdated: '5 days ago',
      strategist: 'Taylor Roberts',
    },
    {
      id: 5,
      item: 'seo for startups',
      volume: 2200,
      difficulty: 'High',
      status: 'approved',
      dateSubmitted: '2025-03-25',
      dateApproved: '2025-03-26',
      lastUpdated: '8 days ago',
      strategist: 'Alex Johnson',
    },
    {
      id: 6,
      item: 'link building services',
      volume: 1800,
      difficulty: 'Very High',
      status: 'needs_revision',
      dateSubmitted: '2025-03-22',
      dateApproved: '2025-03-23',
      revisionReason: 'Too competitive for current resources',
      lastUpdated: '10 days ago',
      strategist: 'Sarah Williams',
    },
  ],
  briefs: [
    {
      id: 1,
      item: 'Customer Onboarding Brief',
      type: 'Frase',
      status: 'awaiting_approval',
    ...
    {
      id: 2,
      item: 'Keyword Research Brief',
      type: 'Google Doc',
      status: 'needs_revision',
      dateSubmitted: '2025-04-01',
      lastUpdated: 'April 18',
      strategist: 'Taylor Roberts',
    },
    {
      id: 3,
      item: 'Conversion Optimization Brief',
      type: 'Google Doc',
      status: 'needs_revision',
      dateSubmitted: '2025-03-31',
      lastUpdated: 'April 12',
      strategist: 'Taylor Roberts',
    },
    {
      id: 4,
      item: 'Competitor Analysis Brief',
      type: 'Google Doc',
      status: 'needs_revision',
      dateSubmitted: '2025-03-30',
      lastUpdated: 'April 8',
  ...
  articles: [
    {
      id: 1,
      item: 'Ultimate Guide to Enterprise SEO in 2025',
      wordCount: 2500,
      status: 'awaiting_approval',
      dateSubmitted: '2025-04-02',
      lastUpdated: '2 days ago',
    ...
    {
      id: 2,
      item: 'How to Choose the Right SEO Agency for Your SaaS',
      wordCount: 1800,
      status: 'awaiting_approval',
      dateSubmitted: '2025-04-01',
      lastUpdated: '3 days ago',
    ...
    {
      id: 3,
      item: 'B2B SEO Strategy: A Step-by-Step Guide',
      wordCount: 2200,
      status: 'resubmitted',
      dateSubmitted: '2025-03-31',
    ...
    {
      id: 4,
      item: '10 Content Marketing Tactics for Tech Companies',
      wordCount: 1500,
      status: 'approved',
      dateSubmitted: '2025-03-27',
      dateApproved: '2025-03-28',
      lastUpdated: '7 days ago',
      strategist: 'Sarah Williams',
    },
    {
      id: 5,
      item: 'SEO for Startups: A Complete Playbook',
      wordCount: 3000,
      status: 'approved',
  ...
  backlinks: [
    {
      id: 1,
      item: 'Tech Industry Backlink Package',
      count: 15,
      status: 'awaiting_approval',
      dateSubmitted: '2025-04-02',
      lastUpdated: '2 days ago',
  ...
  quickwins: [
    ...
    {
      id: 2,
      item: 'Internal Linking Improvements',
      pages: 8,
      status: 'approved',
      dateSubmitted: '2025-03-20',
      dateApproved: '2025-03-21',
...
function ApprovalItem ({
  ...
  return (
    <div className="card bg-white p-4 rounded-lg border border-lightGray"
         style={{ color: '#353233' }}>
      <div
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-3">
        ...
        {'lastUpdated' in item && (
          <div className="text-sm text-mediumGray">
            <span
              className="font-medium">Last Updated:</span> {item.lastUpdated}
          </div>
        )}
      </div>
      ...
      {item.revisionReason && (
        <div className="text-sm text-purple-800 bg-purple-50 p-2 rounded mb-3">
          <span
            className="font-medium">Revision Needed:</span> {item.revisionReason}
        </div>
      )}

      {(item.status === 'awaiting_approval' || item.status === 'resubmitted' ||
  ...
  return (
    <div
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
        ...
        <p className="text-mediumGray text-sm mb-4">Please provide details about
        ...
        <div className="flex justify-end space-x-3">
          ...
          <Button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-scalerrs transition-colors ${reason.trim()
              ? 'text-white bg-primary hover:bg-primary/80'
              : 'text-white bg-primary/50 cursor-not-allowed'}`}
          >
            Submit Feedback
          </Button>
        </div>
...
function GlobalSummaryBanner ({ counts, onTabChange }: {
  ...
  const categoriesCount = Object.values(counts).
    filter(count => count > 0).length

  return (
    <div
      className="card bg-[#FFF8E1] p-4 rounded-lg mb-6 border border-[#FFE082]"
      style={{ color: '#353233' }}>
      <p className="font-medium">You have {totalCount} items awaiting your
        review across {categoriesCount} categories</p>
...
function SidebarSummaryPanel ({ counts, totalApproved, totalPending }: {
  ...
  const percentage = totalPending > 0 ? (totalApproved /
    (totalApproved + totalPending)) * 100 : 0
      ...
      <div className="flex items-center justify-center mb-4">
        <div className="relative w-24 h-24">
          ...
          <div
            ...
            <span
              className="text-lg font-bold">{totalApproved} of {totalApproved +
              totalPending}</span>
    ...
    <div className="overflow-x-auto">
      <table className="min-w-full divide-y divide-lightGray">
        ...
        <tr className="bg-lightGray">
          <th
            className="px-4 py-3 text-left text-xs font-medium text-mediumGray uppercase tracking-wider">Deliverable
          </th>
          <th
            className="px-4 py-3 text-left text-xs font-medium text-mediumGray uppercase tracking-wider">Strategist
          </th>
          <th
            className="px-4 py-3 text-left text-xs font-medium text-mediumGray uppercase tracking-wider">Last
            Updated
          </th>
          <th
            className="px-4 py-3 text-left text-xs font-medium text-mediumGray uppercase tracking-wider">Status
          </th>
          <th
            className="px-4 py-3 text-right text-xs font-medium text-mediumGray uppercase tracking-wider">Actions
          </th>
        </tr>
        </thead>
          ...
          <tr key={item.id} className="hover:bg-lightGray/30">
            <td className="px-4 py-3 whitespace-nowrap">
              <div className="flex items-start">
                <div>
                  <div
                    className="text-sm font-medium text-dark">{item.item}</div>
                  {'type' in item &&
                    <div className="text-xs text-mediumGray">{item.type}</div>}
                  {'wordCount' in item && <div
                    className="text-xs text-mediumGray">{item.wordCount} words</div>}
                  {'volume' in item && <div
                    className="text-xs text-mediumGray">Volume: {item.volume}</div>}
                  {'count' in item && <div
                    className="text-xs text-mediumGray">{item.count} links</div>}
                  {'pages' in item && <div
                    className="text-xs text-mediumGray">{item.pages} pages</div>}
                </div>
              </div>
            </td>
            <td className="px-4 py-3 whitespace-nowrap">
            ...
            <td className="px-4 py-3 whitespace-nowrap text-right">
              {(item.status === 'awaiting_approval' || item.status ===
                'resubmitted' || item.status === 'needs_revision') && (
...
export default function Approvals () {
  ...
  const [rejectionModal, setRejectionModal] = useState(
    { isOpen: false, itemId: 0 })
  const [filter, setFilter] = useState('all')

  // Calculate counts for pending items in each category
  const pendingCounts = {
    keywords: items.keywords.filter(
      item => ['awaiting_approval', 'resubmitted'].includes(
        item.status)).length,
    briefs: items.briefs.filter(
      item => ['awaiting_approval', 'resubmitted'].includes(
        item.status)).length,
    articles: items.articles.filter(
      item => ['awaiting_approval', 'resubmitted'].includes(
        item.status)).length,
    backlinks: items.backlinks.filter(
      item => ['awaiting_approval', 'resubmitted'].includes(
        item.status)).length,
    quickwins: items.quickwins.filter(
      item => ['awaiting_approval', 'resubmitted'].includes(
        item.status)).length,
  }

  // Calculate total approved and pending items
  const totalApproved = Object.values(items).
    flat().
    filter(item => item.status === 'approved').length
  const totalPending = Object.values(pendingCounts).
    reduce((sum, count) => sum + count, 0)
  ...
  const filteredItems = items[activeTab as keyof typeof items].filter(item => {
    ...
    if (filter === 'pending') return [
      'awaiting_approval',
      'resubmitted'].includes(item.status)
  ...
  const handleApprove = (id: number) => {
    setItems(prev => {
      const newItems = { ...prev }
      const itemIndex = newItems[activeTab as keyof typeof items].findIndex(
        item => item.id === id)
  ...
  const confirmRequestChanges = (reason: string) => {
    setItems(prev => {
      const newItems = { ...prev }
      const itemIndex = newItems[activeTab as keyof typeof items].findIndex(
        item => item.id === rejectionModal.itemId)
          ...
          <PageContainer>
            ...
            <PageContainerBody>
              ...
              <div className="mb-4 flex justify-between items-center">
                <div>
                  <p className="font-medium">You
                    have {tabReviewCount} item{tabReviewCount !== 1
                      ? 's'
                      : ''} to review in this section</p>
                </div>
              ...
              <div className="overflow-hidden">
                {filteredItems.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-mediumGray">No items found in this
                      section.</p>
                  </div>
                )}
              </div>
