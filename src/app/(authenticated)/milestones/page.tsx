    ...
    <>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-dark dark:text-white">Campaign
          Milestones</h1>
        <p className="text-mediumGray dark:text-gray-400">Track progress against
          your monthly deliverables and goals</p>
      </div>
      ...
      <div
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="text-right">
            <p className="text-sm text-mediumGray dark:text-gray-400">Month
              Progress</p>
