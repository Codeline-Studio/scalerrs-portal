  ...
  return (
    <>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-dark dark:text-white">Campaign
          Details</h1>
        <p className="text-mediumGray dark:text-gray-400">View your campaign
          scope, team, and timeline</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2">
          <div
            className="bg-white dark:bg-dark p-6 rounded-lg shadow-sm border border-lightGray dark:border-darkGray mb-6">
            <h2 className="text-xl font-bold mb-4">Campaign Overview</h2>
            <div className="mb-4">
              <h3 className="font-medium mb-1">Campaign Type</h3>
              <p className="text-mediumGray dark:text-gray-400">SEO Management +
                Content Creation - Link Building</p>
            </div>
            <div className="mb-4">
              <h3 className="font-medium mb-1">Start Date</h3>
              <p className="text-mediumGray dark:text-gray-400">January 15,
                2024</p>
            </div>
            <div className="mb-4">
              <h3 className="font-medium mb-1">Contract Duration</h3>
              <p className="text-mediumGray dark:text-gray-400">12 months
                (Renews January 2025)</p>
            </div>
            <div>
          ...
          <div
            ...
            <div className="space-y-4">
              <div
                className="flex justify-between items-center pb-2 border-b border-lightGray dark:border-darkGray">
        ...
        <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p
                    className="text-sm text-mediumGray dark:text-gray-400">Account
                    Manager</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <div
                  className="w-10 h-10 rounded-full bg-[#4CAF50] flex items-center justify-center text-white mr-3">
                  MS
                </div>
                <div>
                  <p className="font-medium">Mike Smith</p>
                  <p className="text-sm text-mediumGray dark:text-gray-400">SEO
                    Strategist</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <div
                  className="w-10 h-10 rounded-full bg-[#FF9800] flex items-center justify-center text-white mr-3">
                  AJ
                </div>
                <div>
                  <p className="font-medium">Alex Johnson</p>
                  <p
                    className="text-sm text-mediumGray dark:text-gray-400">Content
                    Manager</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <div
                  className="w-10 h-10 rounded-full bg-[#9C27B0] flex items-center justify-center text-white mr-3">
                  RB
                </div>
                <div>
                  <p className="font-medium">Rachel Brown</p>
                  <p className="text-sm text-mediumGray dark:text-gray-400">Link
          ...
          <div
            ...
            <p className="text-mediumGray dark:text-gray-400 mb-4">Have
              questions about your campaign or need to make adjustments?</p>
            <Button
